    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className="ml-auto flex items-center gap-1">
          <button
            onClick={() => { clearEntries(); xtermRef.current?.clear(); prevEntryCountRef.current = 0; }}
            className={cn(
...
function writeEntry(xterm: Terminal, entry: TerminalEntry) {
  xterm.writeln(`\x1b[1;36m$\x1b[0m ${entry.command}`);
