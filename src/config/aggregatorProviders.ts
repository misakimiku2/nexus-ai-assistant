...
export const ONLINE_PROVIDERS: Record<string, { name: string; logo: string; models: string[]; apiKeyUrl: string; apiUrl: string; isAggregator?: boolean; supportsModelList?: boolean; isCustom?: boolean }> = {
  google: { name: 'Google', logo: 'https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg', models: ['gemini-2.5-pro', 'gemini-2.5-flash', 'gemini-2.5-flash-lite', 'gemini-3.1-pro-preview', 'gemini-3.1-flash-lite-preview', 'gemini-3-flash-preview'], apiKeyUrl: 'https://aistudio.google.com/app/apikey', apiUrl: 'https://generativelanguage.googleapis.com/v1beta', supportsModelList: true },
