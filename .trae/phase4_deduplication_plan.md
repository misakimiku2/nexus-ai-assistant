...
impl MergeService {
    ...
    fn fallback_multi_merge(&self, request: &MultiSourceMergeRequest) -> MergeResult {
        ...
        let parent_ids: Vec<String> = request.existing_memories.iter()
            .map(|m| m.id.clone())
            .collect();
...
impl DeduplicationService {
    ...
    // 关键修正：重新计算 merge_targets（基于更新后的 working_set）
    ...
    async fn multi_source_merge_in_working_set(
        ...
        // 关键修正：parent_ids 必须包含 candidate.id
