...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::memory::generate_embedding,
            commands::memory::search_similar_memories,
            commands::memory::boost_memory,
            commands::memory::update_memory,
            commands::memory::check_model_exists,
            commands::memory::download_embedding_model,
            commands::memory::pause_embedding_download,
            commands::memory::resume_embedding_download,
            commands::memory::cancel_embedding_download,
            commands::memory::get_download_progress,
            commands::memory::open_model_folder,
            commands::memory::delete_embedding_model,
            commands::memory::verify_model_integrity,
            commands::memory::get_model_folder_path,
